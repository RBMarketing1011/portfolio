...
// Inlined from /public/logo so the mark can inherit the brand colour.
export function LogoMark({ className, ...props }: React.ComponentProps<'svg'>) {
	return (
		<svg
			...
			{...props}>
			<path d='M14.3633 17.4522C14.2097 16.8379 14.8085 16.3034 15.4014 16.5255L20.084 18.2813C21.2367 18.7136 22 19.8159 22 21.047C21.9999 22.678 20.6779 24.0001 19.0469 24.0001H18.6309C17.0849 24 15.7374 22.948 15.3623 21.4483L14.3633 17.4522Z' />
			<path d='M34.5986 16.5255C35.1915 16.3034 35.7903 16.8379 35.6367 17.4522L34.6377 21.4483C34.2626 22.948 32.9151 24 31.3691 24.0001H30.9531C29.3221 24.0001 28.0001 22.678 28 21.047C28 19.8159 28.7633 18.7136 29.916 18.2813L34.5986 16.5255Z' />
			<path
				fillRule='evenodd'
				clipRule='evenodd'
