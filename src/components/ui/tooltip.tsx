	...
	return (
		<TooltipPrimitive.Portal>
			<TooltipPrimitive.Content
				...
				className={cn(
					'z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-md border border-white/12 bg-panel/95 px-2.5 py-1.5 text-xs font-medium text-slate-200 shadow-xl backdrop-blur-md',
